...
class Main {
    public static void main(String[] args) {
        ...
        EBook ebook = new EBook("author2", "title of Ebook", 100, 116);
        System.out.println(ebook);

        System.out.println();

        System.out.println(pbook.createReference("article name", 12, 16));
        System.out.println(ebook.createReference("article name", 120, 160));
        System.out.println(ebook.createReference("article name", "2020/04/11"));
