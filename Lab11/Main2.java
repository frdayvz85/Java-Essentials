...
class PrintableAndReversable extends Point implements Printable, Reversable {
    private int prev_x, prev_y;
...
class Main2 {
    ...
    public static void main(String[] args) {
        ...
        PrintableAndReversable p2 = new PrintableAndReversable(10, 20);
        p2.print(); // (10, 20)
        p2.setX(3);
        p2.print(); // (3, 20)
        p2.setX(5);
        ...
        foo(new Book("author", "title of the book"));
        foo(new PrintablePoint(9, 0));
        foo(p2);
